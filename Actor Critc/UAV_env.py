...
class UAVEnv(object):
    ...
    def reset_env(self):
        # self.sum_task_size = 100 * 1048576  # 总计算任务100 Mbits
        self.sum_task_size = 60 * 1048576  # 总计算任务60 Mbits - 修复：使用self.sum_task_size而不是局部变量
    ...
    def reset_step(self):
        ...
        # self.task_list = np.random.randint(2097152, 2621441, self.M)  # 随机计算任务2~2.5Mbits -> 1.5~2 2~2.5 2.5~3 3~3.5 3.5~4
        # self.task_list = np.random.randint(2621440, 3145729, self.M)  # 随机计算任务2.5~3Mbits -> 1.5~2 2~2.5 2.5~3 3~3.5 3.5~4
        # self.task_list = np.random.randint(3145728, 3670017, self.M)  # 随机计算任务3~3.5Mbits -> 1.5~2 2~2.5 2.5~3 3~3.5 3.5~4
        # self.task_list = np.random.randint(3670016, 4194305, self.M)  # 随机计算任务3.5~4Mbits -> 1.5~2 2~2.5 2.5~3 3~3.5 3.5~4
